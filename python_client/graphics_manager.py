...
class GraphicsManager:
    ...
    def draw(self):
        ...
        self.draw_002_stars()
        self.draw_003_actors(self.client_storage.board)
        self.draw_004_highlighted_blocks()
    ...
    def draw_003_actors(self, board: Board):
        for x in range(9):
            for y in range(10):
    ...
    def draw_004_highlighted_blocks(self):
